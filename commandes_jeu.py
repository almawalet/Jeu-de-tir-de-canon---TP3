...
class CommandesJeu:
    ...
    def __init__(self, parent_frame, jeu, angle, puissance):
        ...
        self.afficher_classement_button = tk.Button(self.commandes_frame,
                                                    text="Afficher classement",
                                                    font=("Helvetica", 12),
                                                    command=self.jeu.classement.afficher,
                                                    fg="#1F2937")
        self.afficher_classement_button.pack()
        # - Ajouter le bouton permettant d'afficher le classement (Top 10).
        # - Lorsqu'on clique sur ce bouton, la méthode `self.jeu.classement.afficher` devra être appelée.
